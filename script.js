...
function gradeQuiz(event) {
  ...
  const badge = score === 5 ? "预习完成度优秀" : score >= 3 ? "预习基本过关" : "建议再探索一次";
  quizResult.innerHTML = `<strong>${badge}：${score}/5</strong><br>${missed.length ? missed.join("<br>") : "很棒。你已经抓住机械运动这一章的预习重点，可以带着自己的问题去上课了。"}`;
}
